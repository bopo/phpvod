...
<div class="row">
    ...
    <ul class="list-unstyled vod-infos">
      ...
      <li class="col-xs-8">
          ...
          <dd class="hidden-xs vod-content">{$vod_content|h|msubstr=0,99}<a href="#vod_content" class="btn btn-link ff-text">详细...</a></dd>
        </dl>
      </li>
    </ul>
  ...
  <div class="col-md-4 ff-col visible-lg visible-md">
  	<div class="page-header">
      <h4><span class="glyphicon glyphicon-signal ff-text"></span> 好评榜</h4>
    </div>
    <ol class="ff-vod-hot">
      <volist name=":ff_mysql_vod('cid:'.$vod_cid.';limit:10;cache_name:default;cache_time:default;order:vod_gold;sort:desc')" id="feifei"><li><a href="{:ff_url_vod_read($feifei['list_id'],$feifei['list_dir'],$feifei['vod_id'],$feifei['vod_ename'],$feifei['vod_jumpurl'])}">{$feifei.vod_name|msubstr=0,12,'utf-8',true}</a>
        <small class="pull-right">{$feifei.vod_gold|ff_gold}分</small>
      </li></volist>
    </ol>
  </div><!-- -->
</div>
