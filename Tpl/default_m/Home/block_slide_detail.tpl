<div class="carousel slide" id="ff-slide">
  <!-- 轮播（Carousel）指标 -->
  <ol class="carousel-indicators">
    <volist name=":ff_mysql_vod('field:list_id,list_dir,vod_id,vod_name,vod_ename,vod_jumpurl,vod_pic_slide;cid:'.$list_id.';limit:6;pic_slide:true;cache_name:default;cache_time:default;order:vod_stars desc,vod_id;sort:desc')" id="feifei">
    <eq name="key" value="0">
...
<script>$('#ff-slide').carousel({interval: 2000 });</script>