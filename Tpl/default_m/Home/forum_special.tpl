...
<meta name="keywords" content="{$special['special_name']}专题评论">
<meta name="description" content="{$special['special_name']}影评共有{$page_array.totalpages}页,为你展示的是第{$forum_page}的精彩评论。">
</head>
...
<div class="col-md-10 col-md-offset-1 col-xs-12">
	<p class="text-right">
  	专题链接：<a class="ff-text" href="{:ff_url('special/read', array('id'=>$special['special_id']), true)}">{$special['special_name']}</a>
  </p>
  <div>
...
<div class="col-md-10 col-md-offset-1 col-xs-12">
  <div class="row">
    ...
    <div class="col-md-11 col-xs-10">
      <p class="forum-title">
      	《<a href="{:ff_url('forum/special', array('cid'=>$feifei['forum_cid']), true)}">{$feifei.special_name|msubstr=0,30,'utf-8',true}</a>》的评论
