...
class ApiAction extends HomeAction{
	...
	public function json(){
		//默认定义
		$params = array();
		$params['field'] = 'vod_id,vod_cid,vod_name,vod_title,vod_type,vod_keywords,vod_actor,vod_director,vod_content,vod_pic,vod_area,vod_language,vod_year,vod_addtime,vod_filmtime,vod_server,vod_play,vod_url,vod_inputer,vod_reurl,vod_length,vod_weekday,vod_copyright,vod_state,vod_version,vod_tv,list_name,vod_total,vod_continu,vod_status,vod_stars,vod_hits,vod_isend,vod_scenario';
		//获取地址栏参数
